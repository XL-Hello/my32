...
> 历史实施记录：触摸驱动和 LVGL 输入适配已完成。当前代码分别位于
> `components/drivers/input/xpt2046/`、`components/drivers/display/ili9341/` 与
> `components/adapters/lvgl_port/`；下文旧路径与“待实施”表述仅保留用于追溯。
