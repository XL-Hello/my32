...
- `components/drivers/display/ili9341/lcd.c`：初始化 SPI/DMA 与 ILI9341，并将数据传给 `esp_lcd`。
- `components/drivers/display/ili9341/include/lcd.h`：定义屏幕物理分辨率。
...
| 层次 | 当前实现 | 职责 |
| --- | --- | --- |
| 硬件层 | `components/drivers/input/xpt2046/touch.c` | 初始化 GPIO/SPI，读取 HR2046 原始坐标 |
